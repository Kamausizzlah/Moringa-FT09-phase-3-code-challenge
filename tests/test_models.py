...
class TestModels(unittest.TestCase):
    ...
    def test_magazine_article_title(self):
        magazine = Magazine(name="Tech Weekly", category="Technology")
        titles = magazine.article_title()
        self.assertEqual(len(titles), 0)

    def test_magazine_contribute_authors(self):
        magazine = Magazine(name="Tech Weekly", category="Technology")
        contribute_authors = magazine._contribute_authors()
        self.assertEqual(len(contribute_authors), 0)
